...
class SelectionList extends StatefulWidget {
  SelectionList(this.elements, this.initialSelection,
      {Key? key, this.appBar, this.theme, this.countryBuilder, this.useUiOverlay = true, this.useSafeArea = false})
      : super(key: key);
                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          color: widget.theme?.searchBackgroundColor ?? Colors.white,
                          child: TextField(
          ...
          child: Text(
            ...
            style: (index == posSelected)
                ? TextStyle(
                    ...
                    color: widget.theme?.alphabetSelectedTextColor ?? Colors.white)
                : TextStyle(
                    fontSize: 12, fontWeight: FontWeight.w400, color: widget.theme?.alphabetTextColor ?? Colors.black),
          ),
        ),
      ),
    );
