...
class GroupAddMemberUseCase implements IUseCase<GroupEntity, InputGroupMemberUsecase> {
  final IGroupRepo repo;

  GroupAddMemberUseCase(this.repo);
  @override
  Future<Either<IFailure, GroupEntity>> call(params) {
    return repo.addUserToGroup(groupId: params.groupId, phoneNumber: params.phoneNumber);
  }
}
